...
from utils import poisson5d_slice_sampler, infer_on_coords, visualize_solution_2d, poisson10d_slice_sampler, benchmark_memory, make_loss, benchmark_forward
import json
import random
...
if __name__ == '__main__':
    ...
    for expert_rank in r_values:
        ...
        coords_test_forward = sample_interior(8192, device=device)
        ...
        result_key = f"5dPoisson_r_{expert_rank}"
        ...
        file_path = "training_results_5d_r.json"
